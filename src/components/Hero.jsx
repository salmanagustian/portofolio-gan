        ...
        <div className="hero-inner">
          <div className="hero-content">
            ...
            <div className="hero-text hero-cta">
              ...
              <a
                href="mailto:salmanmuhammad1976@gmail.com"
                className="btn-ghost"
              >
                Get in Touch
              </a>
          ...
          <div className="hero-schematic">
            ...
            >
              ...
              {/* Outer frame */}
              <rect
                className="svg-draw svg-draw-d1 svg-measure"
                x="10"
                y="10"
                width="360"
                height="300"
              ...
              <g stroke="#7EC8E3" strokeWidth="1" opacity="0.5">
                ...
                <line x1="370" y1="10" x2="358" y2="10" />
                <line x1="370" y1="10" x2="370" y2="22" />
                <line x1="10" y1="310" x2="22" y2="310" />
                <line x1="10" y1="310" x2="10" y2="298" />
                <line x1="370" y1="310" x2="358" y2="310" />
                <line x1="370" y1="310" x2="370" y2="298" />
              </g>

              {/* CLIENT */}
              <rect
                className="svg-draw svg-draw-d2 svg-measure"
                x="20"
                y="136"
                width="64"
                height="32"
              ...
              />
              <text
                className="svg-fade svg-fade-d2"
                x="52"
                y="156"
              ...
              {/* CLIENT → API_GATEWAY */}
              <line
                className="svg-draw svg-draw-d3 svg-measure"
                x1="84"
                y1="152"
                x2="116"
                y2="152"
              ...
              />
              <text
                className="svg-fade svg-fade-d3"
                x="100"
                y="146"
                fontFamily="'IBM Plex Mono',monospace"
                fontSize="7"
              ...
              <line
                className="svg-draw svg-draw-d4 svg-measure"
                x1="166"
                y1="120"
                x2="166"
                y2="76"
              ...
              />
              <text
                className="svg-fade svg-fade-d4"
                x="178"
                y="100"
                fontFamily="'IBM Plex Mono',monospace"
                fontSize="7"
              ...
              {/* MSG_BROKER */}
              <rect
                className="svg-draw svg-draw-d5 svg-measure"
                x="252"
                y="120"
                width="100"
                height="64"
              ...
              />
              <text
                className="svg-fade svg-fade-d5"
                x="302"
                y="146"
                fontFamily="'IBM Plex Mono',monospace"
                fontSize="8.5"
              ...
              {/* MSG_BROKER → DATABASE */}
              <line
                className="svg-draw svg-draw-d6 svg-measure"
                x1="302"
                y1="184"
                x2="302"
                y2="224"
              ...
              />
              <text
                className="svg-fade svg-fade-d6"
                x="316"
                y="206"
                fontFamily="'IBM Plex Mono',monospace"
                fontSize="7"
              ...
              {/* CACHE */}
              <rect
                className="svg-draw svg-draw-d7 svg-measure"
                x="84"
                y="240"
                width="72"
                height="32"
              ...
              />
              <text
                className="svg-fade svg-fade-d7"
                x="120"
                y="260"
                fontFamily="'IBM Plex Mono',monospace"
                fontSize="8.5"
